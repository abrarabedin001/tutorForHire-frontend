...
const TeacherCard = ({
  ...
  return (
    <Card className={className} sx={{ width: 1800, height: 800 }}>
      ...
      <div className="teacher-card__info p-5">
        ...
        <p className="mt-3 text-black" style={{ fontWeight: 'bold', fontSize: '20px' }}>
        {TeacherProfile.user.name}
        </p>
        </h3>
        <p className="mt-3 text-black" style={{ fontWeight: 'bold', fontSize: '16px' }}>
          Email:
        </p>
